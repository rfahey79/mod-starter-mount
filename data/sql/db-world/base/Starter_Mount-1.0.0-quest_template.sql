...
@logdescription := "Greetings traveler! If you're en-route to the Lion's Pride Inn, it's quite a trek. If you continue east a bit further you'll find the Eastvale Logging Camp. Talk to the Riding Trainer there, Randal Hunter, he should be able to set you up with some transportation.
",
@questdescription := "",
@areadescription := "",
@questcompletionlog := "",
